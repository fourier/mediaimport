...
(defvar *test-data-path* (fad:merge-pathnames-as-directory (asdf:system-relative-pathname :mediaimport-test #P"t/") #P"data/"))
...
(defmacro test-input (fun inp out)
  ...
  ;; (is (mediaimport.details.nt::splitdrive "C:\\")
  ;;     '("C:" . "\\")
	;;   :test #'equal
  ;;     "Testing input: 'C:\\'"))
  (let ((inp-string
